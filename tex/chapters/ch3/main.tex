...
Note, in Algorithm~\ref{alg:supp_en}, solutions are not guaranteed to exist for (\ref{eqn:lin_eqn_1_se}) and (\ref{eqn:lin_eqn_2_se}). In this case, the support does not yield a Nash
equilibrium. 
