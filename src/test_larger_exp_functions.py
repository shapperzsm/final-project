import database_code.experiment_functions as expfun
...
def test_get_game(num_of_opponents, tournament_rep, prob_of_game_ending, noise):
    ...
    game = expfun.get_game(tournament_rep, players, prob_of_game_ending, noise)
...
def test_get_prob_of_defection(
    ...
    defection_prob = expfun.get_prob_of_defection(game["payoff matrix obtained"])
