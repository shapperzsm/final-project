...
for each_set in range(maximum_player_set):
    ...
    for noise in list(each_set_data["noise"].drop_duplicates()):    
        ...
        if min_threshold == max_threshold:
            ...
            prob_greater_than_min = specific_noise_data["prob_of_game_ending"] > min_threshold
            prob_less_than_max = specific_noise_data["prob_of_game_ending"] < max_threshold
            
            threshold_between = specific_noise_data[prob_greater_than_min & prob_less_than_max]
